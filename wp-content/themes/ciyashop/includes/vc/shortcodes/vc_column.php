...
add_action( 'init', 'ciyashop_extend_vc_column', 1000 );
/**
 * Extend vc column
 */
function ciyashop_extend_vc_column() {
	if ( ! function_exists( 'vc_add_params' ) ) {
		return;
	}

	// Get shortcode config.
	$shortcode_tmp = vc_get_shortcode( 'vc_column' );
	...
	vc_map_update( 'vc_column', $shortcode_tmp );
}
