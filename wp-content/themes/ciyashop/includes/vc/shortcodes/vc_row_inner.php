 ...
 * @package CiyaShop
 */
add_action( 'init', 'ciyashop_extend_vc_row_inner', 1000 );
/**
 * Extend vc row inner
 */
function ciyashop_extend_vc_row_inner() {
	if ( ! function_exists( 'vc_add_params' ) ) {
		return;
	}

	// Get shortcode config.
	$shortcode_tmp = vc_get_shortcode( 'vc_row_inner' );
	...
	vc_map_update( 'vc_row_inner', $shortcode_tmp );
}
